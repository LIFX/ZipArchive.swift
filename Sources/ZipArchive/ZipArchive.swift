...
public class ZipArchive {
    ...
    public init(
        stream: IOStream,
        mode: ZipArchiveMode,
        entryNameEncoding: String.Encoding) throws {
...
public extension ZipArchive {
    ...
    public convenience init(
        ...
        entryNameEncoding: String.Encoding = .utf8) throws {
        ...
        try self.init(stream: stream!, mode: mode, entryNameEncoding: entryNameEncoding)
    }

...
public class DeflateStream: ZipArchiveEntryStream {
    ...
    public func read(buffer: UnsafeMutableRawPointer, maxLength len: Int) -> Int {
        ...
        #if os(Linux)
            crc32 = CZlibLinux.crc32(crc32, buffer.assumingMemoryBound(to: UInt8.self), UInt32(readBytes))
        #else
            crc32 = CZlibDarwin.crc32(crc32, buffer.assumingMemoryBound(to: UInt8.self), UInt32(readBytes))
        #endif
    ...
    public func write(buffer: UnsafeRawPointer, maxLength len: Int) -> Int {
        ...
        #if os(Linux)
            crc32 = CZlibLinux.crc32(crc32, mutableBuffer, bufferSize)
        #else
            crc32 = CZlibDarwin.crc32(crc32, mutableBuffer, bufferSize)
        #endif

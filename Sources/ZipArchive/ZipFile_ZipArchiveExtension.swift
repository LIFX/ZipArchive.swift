...
//    }
    ...
    public func createEntryFrom(filePath: String, entryName: String, compressionLevel: CompressionLevel = .default, encryptionStreamFactory: ZipEncryptionStreamFactory? = nil) throws -> ZipArchiveEntry {
...
//            }
        ...
        let zipStream = try entry.open(encryptionStreamFactory: encryptionStreamFactory, isLargeFile: isLargeFile)
        defer {
            zipStream.close()
        }
...
//    }
    ...
    public func extractTo(directoryPath: String, encryptionStreamFactory: ZipEncryptionStreamFactory? = nil) throws {
        ...
        for entry in files {
            ...
            try entry.extractTo(filePath: fullPath, overwrite: false, encryptionStreamFactory: encryptionStreamFactory)
